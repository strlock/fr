...
class Block_Library_Source extends Source_Base {
	...
	public function get_title() {
		return __( 'Block Library', ALOHA_DOMAIN );
	}
	...
	private function prepare_template( array $template_data ) {
        error_log('library-source.php line 77 URL: '. $template_data['url'] );
		return [
	...
	public function get_data( array $args, $context = 'display' ) {
		...
		if ( empty( $data ) || empty( $data['content'] ) ) {
			throw new \Exception( __( 'Template does not have any content', ALOHA_DOMAIN ) );
		}
        ...
        private static function get_library_url(){
            ...
            if($template_name==='bellevue'){
                return 'https://template.bellevuetheme.com';
                //return 'http://localhost/bdash';
            }
