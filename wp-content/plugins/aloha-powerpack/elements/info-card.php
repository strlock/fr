...
class Themo_Widget_Info_Card extends Widget_Base {
	...
	public function get_title() {
		return __( 'Info Card', ALOHA_DOMAIN );
	}
	...
	protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Link Text', ALOHA_DOMAIN ),
                'dynamic' => [
                    'active' => true,
                ]
            ]
        ...
        $this->add_control(
            'button_1_link',
            [
                'label' => __( 'Link 1', ALOHA_DOMAIN ),
                'type' => Controls_Manager::URL,
                'placeholder' => __( '#link', ALOHA_DOMAIN ),
                'separator' => 'none',
                'dynamic' => [
                    'active' => true,
                ],
        ...
        $this->add_control(
            'link_2_color',
            [
                'label' => __( 'Link 2 Color', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
		...
		<div class="th-info-card-wrap">
            <div class="elementor-icon-box-wrapper">
                <div class="elementor-icon-box-content">
                    <<?php echo esc_attr($settings['title_size']); ?> class="elementor-icon-box-title"><?php echo esc_html( $settings['title_text'] ); ?></<?php echo esc_attr($settings['title_size']); ?>>
	...
	protected function content_template() {
        ...
        <div class="th-info-card-wrap">
            <div class="elementor-icon-box-wrapper">
                <div class="elementor-icon-box-content">
                    <{{ settings.title_size }} class="elementor-icon-box-title">{{{ settings.title_text }}}</{{ settings.title_size }}>
