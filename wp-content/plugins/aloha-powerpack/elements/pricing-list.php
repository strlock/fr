...
class Themo_Widget_Pricing_List extends Widget_Base {
        ...
        public function get_style_depends(){
            ...
            wp_register_style( $this->get_name(), THEMO_URL . 'css/pricing-list.css', array(), $modified );
	...
	public function get_title() {
		return __( 'Pricing List', ALOHA_DOMAIN );
	}
	...
	protected function register_controls() {
        ...
        $repeater->add_control(
            'price_sub_title', [
            'label' => __( 'Subtitle', ALOHA_DOMAIN ),
            'type' => Controls_Manager::TEXT,
            'placeholder' => __( 'Subtitle', ALOHA_DOMAIN ),
            'label_block' => true,
            'default' => __( 'Subtitle', ALOHA_DOMAIN ),
            'dynamic' => [
                'active' => true,
            ]
            ]
        ...
        $repeater->add_control(
            ...
            'placeholder' => __( "Add a description here.", ALOHA_DOMAIN ),
            'default' => __( "Add a description here.", ALOHA_DOMAIN ),
            'label_block' => true,
            'dynamic' => [
                'active' => true,
            ],
        ...
        $repeater->add_control(
            ...
            'label' => __( 'Use button', ALOHA_DOMAIN ),
...
//        );
        ...
        $repeater->add_control(
            'price_price', [
            'label' => __( 'Price number', ALOHA_DOMAIN ),
            'type' => Controls_Manager::TEXT,
            'placeholder' => __( '$99', ALOHA_DOMAIN ),
            'default' => __( '$99', ALOHA_DOMAIN ),
            'label_block' => true,
            'dynamic' => [
                'active' => true,
            ],
...
//            ],
        ...
        $this->add_control(
            'pricing',
            [
                'label' => __( 'Pricing List', ALOHA_DOMAIN ),
                'type' => Controls_Manager::REPEATER,
                'default' => [
                    [
                        'price_title' => __( 'Title', ALOHA_DOMAIN ),
                        'price_sub_title' => __( 'Subtitle', ALOHA_DOMAIN ),
                        'price_description' => __( "Morbi volutpat risus vitae quam pellentesque lobortis a eu urna.", ALOHA_DOMAIN ),
                        'price_price' => __( '$59', ALOHA_DOMAIN ),
                        'price_text' => __( 'each', ALOHA_DOMAIN ),
                        'price_divider' => __( 'yes', ALOHA_DOMAIN ),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Border & Background', ALOHA_DOMAIN ),
                'tab' => Controls_Manager::TAB_STYLE,
                'condition' => [
                    'style' => ['style_2','style_3']
                ],
        ...
        $this->add_control(
            'background_1',
            [
                'label' => __( 'Background 1', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
        ...
        $this->add_control(
            'background_2',
            [
                'label' => __( 'Background 2', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
