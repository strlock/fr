...
class Themo_Widget_Pricing extends Widget_Base {
	...
	public function get_title() {
		return __( 'Pricing', ALOHA_DOMAIN );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_pricing',
			[
				'label' => __( 'Pricing Table', ALOHA_DOMAIN ),
			]
		);
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Featured', ALOHA_DOMAIN ),
				'tab' => Controls_Manager::TAB_STYLE,
			]
		);
    ...
    protected function add_repeater_controls( Repeater $repeater ) {
        $repeater->add_control(
            ...
            [
                ...
                'placeholder' => __( 'Price 1', ALOHA_DOMAIN ),
                'label_block' => true,
        ...
        $repeater->add_control(
            'price_col_sub_title',
            [
                'label' => __( 'Sub Title', ALOHA_DOMAIN ),
                'type' => Controls_Manager::TEXT,
                'default' => __( 'Sub Title', ALOHA_DOMAIN ),
                'placeholder' => __( 'Sub Title', ALOHA_DOMAIN ),
                'label_block' => true,
                'dynamic' => [
                    'active' => true,
                ]
    ...
    protected function get_repeater_defaults() {
        ...
        return [
            [
                'price_col_title' => __( 'Title', ALOHA_DOMAIN ),
                'price_col_sub_title' => __( 'Sub Title', ALOHA_DOMAIN ),
                'price_col_price' => __( '$59', ALOHA_DOMAIN ),
                'price_col_text' => __( '/each', ALOHA_DOMAIN ),
                'price_col_description' => __( "Maecenas tristique\nUllamcorper mauris\nElementum tortor\nClass aptent", ALOHA_DOMAIN ),
                'price_col_button_1_show' => __( 'yes', ALOHA_DOMAIN ),
                'price_col_button_1_text' => __( 'BUTTON TEXT', ALOHA_DOMAIN ),
                'price_col_button_1_style' => __( 'ghost-primary', ALOHA_DOMAIN ),
            ],
            [
                'price_col_title' => __( 'Title', ALOHA_DOMAIN ),
                'price_col_sub_title' => __( 'Sub Title', ALOHA_DOMAIN ),
                'price_col_price' => __( '$79', ALOHA_DOMAIN ),
                'price_col_text' => __( '/each', ALOHA_DOMAIN ),
                'price_col_description' => __( "Maecenas tristique\nUllamcorper mauris\nElementum tortor\nClass aptent", ALOHA_DOMAIN ),
                'price_col_button_1_show' => __( 'yes', ALOHA_DOMAIN ),
                'price_col_button_1_text' => __( 'BUTTON TEXT', ALOHA_DOMAIN ),
                'price_col_button_1_style' => __( 'ghost-light', ALOHA_DOMAIN ),
                'price_col_featured' => __( 'yes', ALOHA_DOMAIN ),
            ],
            [
                'price_col_title' => __( 'Title', ALOHA_DOMAIN ),
                'price_col_sub_title' => __( 'Sub Title', ALOHA_DOMAIN ),
                'price_col_price' => __( '$99', ALOHA_DOMAIN ),
                'price_col_text' => __( '/each', ALOHA_DOMAIN ),
                'price_col_description' => __( "Maecenas tristique\nUllamcorper mauris\nElementum tortor\nClass aptent", ALOHA_DOMAIN ),
                'price_col_button_1_show' => __( 'yes', ALOHA_DOMAIN ),
                'price_col_button_1_text' => __( 'BUTTON TEXT', ALOHA_DOMAIN ),
