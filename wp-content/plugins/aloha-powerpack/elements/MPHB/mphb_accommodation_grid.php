...
class Themo_Widget_Accommodation_Grid extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Accommodation Grid', ALOHA_DOMAIN );
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            ...
            [
                ...
                'descrition' => __( 'Use Accommodation Category to filter your results.', ALOHA_DOMAIN ),
        ...
        $this->add_control(
            'group',
            [
                'label'   => __( 'Select by Category', ALOHA_DOMAIN ),
                'type'    => Controls_Manager::SELECT2,
                'label_block' => true,
                'multiple'    => true,
                //'default' => 'none',
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Hover Color', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'alpha' => false,
                'default' => '',
                'selectors' => [
        ...
        <div id="<?php echo esc_attr($th_uid); ?>" class="th-portfolio">
            ...
            <div id="th-portfolio-row" class="th-portfolio-row row portfolio_content <?php echo esc_attr($portfolio_row); ?>">
                ...
                if ( $settings['individual'] ) {
                    //echo '<pre>'; print_r($settings['individual']); echo '</pre>';
                ...
                if ( (isset($args['post__in']) && count($args['post__in']) > 0) && !$query->have_posts() ) {

                    unset($args['post__in']);
                    $query = new \WP_Query( $args );
                }

                if ( (isset($args['tax_query']) && count($args['tax_query']) > 0) && !$query->have_posts() ) {
