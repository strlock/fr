...
class Themo_Widget_MPHB_Search_Results extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Availability Search Results', ALOHA_DOMAIN );
    }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Information Section', ALOHA_DOMAIN ),
            ]
        );

        $this->add_control('counter_text', array(
            'type'        => Controls_Manager::SWITCHER,
            'label'       => __('Section', ALOHA_DOMAIN),
            'description' => __('Displays above Recommendation Section. Example: "2 accommodations found from [Start Date] - till [End Date]', ALOHA_DOMAIN),
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Recommendation Section', ALOHA_DOMAIN ),
            ]
        );
        ...
        $this->add_control('recommendation_content', array(
            'type'        => Controls_Manager::SWITCHER,
            'label'       => __('Section', ALOHA_DOMAIN),
            'description' => __('Displays above Search Results. It recommends the best set of accommodations according to a number of guests in a list.', ALOHA_DOMAIN),
            'label_on' => __( 'On', ALOHA_DOMAIN ),
            'label_off' => __( 'Off', ALOHA_DOMAIN ),
            'selectors' => [
        ...
        $this->add_control('recommendation_title', array(
            ...
            //'description' => __('Whether to display title of the accommodation type.', ALOHA_DOMAIN),
            'label_on' => __( 'On', ALOHA_DOMAIN ),
            'label_off' => __( 'Off', ALOHA_DOMAIN ),
            'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Reservation Details & Cart', ALOHA_DOMAIN ),
            ]
        );

        $this->add_control('cart_empty', array(
            'type'        => Controls_Manager::SWITCHER,
            'label'       => __('Hide Empty Cart Message', ALOHA_DOMAIN),
            //'description' => __('Displays above Search Results. It recommends the best set of accommodations according to a number of guests in a list.', ALOHA_DOMAIN),
            'label_on' => __( 'On', ALOHA_DOMAIN ),
            'label_off' => __( 'Off', ALOHA_DOMAIN ),
            'selectors' => [
        ...
        $this->start_controls_section(
            ...
            [
                'label' => __( 'Search Results', ALOHA_DOMAIN ),
            ]
        );
        ...
        $this->add_control('featured_image', array(
            'type'        => Controls_Manager::SWITCHER,
            'label'       => __('Featured image', ALOHA_DOMAIN),
            'label_on' => __( 'Show', ALOHA_DOMAIN ),
            'label_off' => __( 'Hide', ALOHA_DOMAIN ),
            'return_value' => 'yes',
            'default' => 'yes',
        ...
        $this->add_control(
            'show_icon_titles',
            [
                'label' => __( 'Icon Titles', ALOHA_DOMAIN ),
                'type' => Controls_Manager::SWITCHER,
        ...
        $this->add_control('view_button', array(
            'type'        => Controls_Manager::SWITCHER,
            'label'       => __('View Link', ALOHA_DOMAIN),
            //'description' => __('Whether to display "View Details" button with the link to accommodation type.', ALOHA_DOMAIN),
            'label_on' => __( 'Show', ALOHA_DOMAIN ),
            'label_off' => __( 'Hide', ALOHA_DOMAIN ),
            'return_value' => 'yes',
            'default' => 'yes',
        ...
        $this->add_control('orderby', array(
            ...
            'options'     => array(
                ...
                'post__in'       => __('Price', ALOHA_DOMAIN)
            )
        ));
        ...
        $this->add_control(
            ...
            [
                ...
                'raw' => __( '<p style="line-height: 17px;">Displays above Recommendation Section. Example: "2 accommodations found from [Start Date] - till [End Date]</p>', ALOHA_DOMAIN ),
        ...
        $this->add_control(
            ...
            [
                'type' => Controls_Manager::RAW_HTML,
                'raw' => __( '<p style="line-height: 17px;">Displays above Search Results. It recommends the best set of accommodations according to a number of guests in a list.</p>', ALOHA_DOMAIN ),
                'content_classes' => 'themo-elem-html-control',
            ]
        );
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Reserve Button', ALOHA_DOMAIN ),
                'type' => Controls_Manager::SELECT,
        ...
        $this->add_control(
            'cart_text_color',
            [
                'label' => __( 'Cart Text', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Confirm Button', ALOHA_DOMAIN ),
                'type' => Controls_Manager::SELECT,
                'default' => 'standard-primary',
                'options' => [
                    'standard-primary' => __( 'Standard Primary', ALOHA_DOMAIN ),
        ...
        $this->add_control(
            'icon_details_color',
            [
                'label' => __( 'Attribute Icon', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'icon_title_color',
            [
                'label' => __( 'Attribute Title', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            'value_details_color',
            [
                'label' => __( 'Attribute Value', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Attribute Link', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Price Description', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'default' => '',
                'selectors' => [
