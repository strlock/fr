...
class Themo_Widget_Itinerary extends Widget_Base {
	...
	public function get_title() {
		return __( 'Itinerary', ALOHA_DOMAIN );
	}
	...
	protected function register_controls() {
		$this->start_controls_section(
			'section_toggles',
			[
				'label' => __( 'Itinerary', ALOHA_DOMAIN ),
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => [
					[
						'tab_title' => __( 'Day 1 Training', ALOHA_DOMAIN ),
						'tab_content' => __( 'Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at lobortis. Fusce dapibus, tellus ac cursus commodo.', ALOHA_DOMAIN ),
					],
					[
						'tab_title' => __( 'Day 2 Rafting Whitewater', ALOHA_DOMAIN ),
						'tab_content' => __( 'Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at lobortis. Fusce dapibus, tellus ac cursus commodo.', ALOHA_DOMAIN ),
					],
                    [
                        'tab_title' => __( 'Day 3 Rafting The Chilko', ALOHA_DOMAIN ),
                        'tab_content' => __( 'Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at lobortis. Fusce dapibus, tellus ac cursus commodo.', ALOHA_DOMAIN ),
                    ],
				],
				'fields' => [
					[
						'name' => 'tab_title',
						'label' => __( 'Title & Content', ALOHA_DOMAIN ),
						'type' => Controls_Manager::TEXT,
						'label_block' => true,
						'default' => __( 'Itinerary Title' , ALOHA_DOMAIN ),
                        'dynamic' => [
                            'active' => true,
                        ],
					],
					[
						...
						'default' => __( 'Itinerary Content', ALOHA_DOMAIN ),
						'show_label' => false,
                        'dynamic' => [
                            'active' => true,
                        ],
		...
		$this->add_control(
			'expanded',
			[
				'label' => __( 'Start all Items Expanded', ALOHA_DOMAIN ),
		...
		$this->add_control(
			'width',
			[
				'label' => __( 'Width', ALOHA_DOMAIN ),
				'type' => Controls_Manager::SELECT,
				'default' => 'th-itin-narrow',
				'options' => [
					'th-itin-narrow' => __( 'Narrow', ALOHA_DOMAIN ),
					'th-itin-med' => __( 'Medium', ALOHA_DOMAIN ),
					'th-itin-fw' => __( 'Full Width', ALOHA_DOMAIN ),
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'options' => [
					'th-itin-center' => __( 'Center', ALOHA_DOMAIN ),
					'th-itin-left' => __( 'Left', ALOHA_DOMAIN ),
				],
			]
		);
        ...
        $this->add_control(
            'vertical_line_color',
            [
                'label' => __( 'Vertical Line Color', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            'dot_color',
            [
                'label' => __( 'Dot Color', ALOHA_DOMAIN ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
