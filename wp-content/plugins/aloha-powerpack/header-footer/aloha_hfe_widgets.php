...
//            'post-info', we have post info too...
        ...
        //using the elementor hook to register modules, if following the HFE way, make sure it's done properly
        //and Elementor pro widgets don't disappear
     ...
     * 
     */
    function register_modulesX($manager) {
