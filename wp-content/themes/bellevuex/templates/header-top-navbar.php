...
if ( function_exists( 'get_theme_mod' ) ) {
    ...
    //echo "dropdown_style = ".$dropdown_style;
    ...
    if(isset($dropdown_style) && ($dropdown_style == 'dark' || $dropdown_style == '')){
    ...
    if(($themo_post_type == 'page' || $themo_post_type == 'block_template' || $themo_post_type == 'themo_room' || $themo_post_type == 'mphb_room_type' ||
            $themo_post_type == 'mphb_room_service' || ($elm_pro_loaded && $themo_post_type == 'post'))
...
<header class="banner theme-header navbar navbar-default navbar-static-top <?php echo sanitize_text_field($header_dark_style_class);?>" role="banner" <?php echo sanitize_text_field($transparent_header);?>>
    <?php
        if ( function_exists( 'get_theme_mod' ) ) {
        /* Top Nav Enabled? */
        ...
        <div class="navbar-header">
            ...
            <div id="logo">
                <a href="<?php echo esc_url(home_url('/')); ?>">
                    <?php
                    if ($transparency && $transparent_logo_enabled && $th_alt_logo == "on") {
                        $logo_set = true;
                        // If trans header on and there is a alt logo and it's enabled on page settings, show it  
                        ?>
                        ...
                        <?php
                    } elseif ($transparency && (!$transparent_logo_enabled or!$th_alt_logo or $th_alt_logo == 'Off')) {
                        $logo_set = true;
// If trans header on but alt logo is turned off or it's not enabed on the page settings don't show 
                        ?>
        ...
        // Social Icons
        if (function_exists('get_theme_mod')) {
            $woo_cart_header_display = get_theme_mod('themo_nav_social_switch', false);
