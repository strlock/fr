...
class Themo_Widget_Accommodation_Listing_FR extends Widget_Base {
    ...
    public function get_title() {
        return __('Accommodation Listing', ALOHA_DOMAIN);
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
                'thmv_data_source',
                [
                    'label' => __('Source', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'themo_room_type',
                    'options' => [
                        'themo_room_type' => __('Rooms', ALOHA_DOMAIN),
                        'mphb_room_type' => __('Accommodations', ALOHA_DOMAIN),
                    ],
                    'condition' => [
        ...
        //get class and don't add this for the search class
        if(get_class($this)!=='Elementor\Themo_Widget_Accommodation_Search'){
            $this->add_control(
                'order',
                [
        ...
        $this->add_responsive_control(
                'thmv_hide_highlight',
                [
                    'label' => __('Highlight', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
                    'selectors' => [
        ...
        $this->add_responsive_control(
                'thmv_hide_location',
                [
                    'label' => __('Location', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
                    'selectors' => [
        ...
        /** activate **/
        $this->add_control(
            'thmv_section_activate_data_heading',
            [
                'label' => __('Activate', 'elementor'),
                'type' => Controls_Manager::HEADING,
                'separator' => 'before',
                'condition' => [
                    'thmv_data_switcher' => 'yes',
        ...
        $this->add_control(
            'thmv_link_image',
            [
                'label' => __('Link Image', ALOHA_DOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', ALOHA_DOMAIN),
                'label_off' => __('No', ALOHA_DOMAIN),
                'condition' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Link Title', ALOHA_DOMAIN),
                'type' => Controls_Manager::SWITCHER,
                'label_on' => __('Yes', ALOHA_DOMAIN),
                'label_off' => __('No', ALOHA_DOMAIN),
                'condition' => [
        ...
        $this->start_controls_section(
                ...
                [
                    'label' => __('Listings', ALOHA_DOMAIN),
                    'condition' => [
                        'thmv_data_switcher' => '',
                    ],
                ]
        ...
        $listing->add_control(
                'thmv_style',
                [
                    'label' => __('Choose style', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SELECT,
                    'default' => 'style_1',
                    'options' => [
                        ...
                        'style_4' => __('Style 4', ALOHA_DOMAIN),
                        'style_5' => __('Style 5', ALOHA_DOMAIN),
                        'style_6' => __('Style 6', ALOHA_DOMAIN),
                    ],
                ]
        );
        /** tabs begin * */
        ...
        $listing->add_control(
                ...
                [
                    'label' => __('Carousel', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => '',
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
        ...
        $listing->add_control(
                ...
                [
                    'label' => __('Show images on the right side', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'default' => '',
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
        ...
        $listing->add_control(
                ...
                [
                    ...
                    'default' => __('Newly Renovated', ALOHA_DOMAIN),
                    'placeholder' => __('Newly Renovated', ALOHA_DOMAIN),
                    'label_block' => true,
                    'dynamic' => [
                        'active' => true,
                    ],
        ...
        $listing->add_control(
                ...
                [
                    'label' => __('Preface', ALOHA_DOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => __('4 guests, 2 bedrooms, 1 bath', ALOHA_DOMAIN),
                    'placeholder' => __('4 guests, 2 bedrooms, 1 bath', ALOHA_DOMAIN),
                    'label_block' => true,
                    'dynamic' => [
                        'active' => true,
                    ],
        ...
        $listing->add_control(
                ...
                [
                    'label' => __('Title Separator', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SWITCHER,
                    'label_on' => __('Yes', ALOHA_DOMAIN),
                    'label_off' => __('No', ALOHA_DOMAIN),
                    'return_value' => 'yes',
        ...
        $listing->add_control(
                'thmv_price_before',
                [
                    'label' => __('Before Price', ALOHA_DOMAIN),
                    'type' => Controls_Manager::TEXT,
                    'default' => __('Starting at', ALOHA_DOMAIN),
                    'placeholder' => __('Starting at', ALOHA_DOMAIN),
                    'dynamic' => [
                        'active' => true,
                    ],
                ]
        ...
        $listing->add_control(
                'thmv_price_after',
                [
                    'label' => __('After Price', ALOHA_DOMAIN),
                    'type' => Controls_Manager::TEXT,
        ...
        $this->add_control(
                ...
                [
                    'label' => __('Background Blur', ALOHA_DOMAIN),
                    'type' => Controls_Manager::SLIDER,
                    'default' => [
                        'size' => 25,
                    ],
...
//                        '{{WRAPPER}} .thmv-icons.thmv-grid-facility .elementor-icon.thmv-icon' => 'font-size: {{SIZE}}{{UNIT}};',
        ...
        $this->add_control(
                ...
                [
                    'label' => __('Label Color', ALOHA_DOMAIN),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => __('Location Color', ALOHA_DOMAIN),
                    'type' => Controls_Manager::COLOR,
                    'default' => '',
                    'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __('Before Color', ALOHA_DOMAIN),
                'type' => Controls_Manager::COLOR,
                'default' => '#1C1715',
                'selectors' => [
        ...
        $this->add_control(
                ...
                [
                    'label' => __('After Color', ALOHA_DOMAIN),
                    'type' => Controls_Manager::COLOR,
                    'default' => '#1C1715',
                    'selectors' => [
        ...
        $this->start_controls_section(
            ...
            $this->add_control(
                    ...
                    [
                        'label' => __('Arrows Spacing', ALOHA_DOMAIN),
                        'type' => Controls_Manager::SLIDER,
                        'default' => [
                            'size' => 15,
                        ],
            ...
            $this->add_control(
                    ...
                    [
                        'label' => __('Margin Bottom', ALOHA_DOMAIN),
                        'type' => Controls_Manager::SLIDER,
                        'default' => [
                            'size' => 15,
                        ],
    ...
    protected function renderSlider($settings, $images, $link_url) {
        ...
        if($is_top_level_carousel_active){
            ...
            ob_start();
            if ($this->get_settings_for_display('thmv_link_image') === "yes"):
            ...
            foreach ($images as $attachment) {
                ...
                if ($this->get_settings_for_display('thmv_link_image') === "yes"):
                   $slide_html .= '<a href="'.$link_url.'">';
                endif;
                
                $slide_html .= '<figure class="swiper-slide-inner">' . $image_html;
                $slide_html .= '</figure>';
    ...
    protected function getDataPosts(){
        ...
        $args = array();
            ...
            //for search results, we need to fix the order and orderby terms
            
            if($this->get_name()==='themo-accommodation-search-results'){
...
//                $titleSeparator = $list['thmv_title_separator'];
                ...
                if (empty($link_text)) {
                    $link_text = __('Learn More', ALOHA_DOMAIN);
                }
...
//                $icons = $this->getIcons($list);
                    ...
                    <div class="thmv-grid <?= $imageAlignment ?> elementor-element">
                        <div class="thmv-grid-img">
                            <?php if (!$carousel_switcher && !empty($renderedImage)): ?>
                                <?php if ($this->get_settings_for_display('thmv_link_image') === "yes"): ?>
                            ...
                            if ($carousel_switcher && is_array($carouselImages)):
                                $this->renderSlider($imageSizeInfo, $carouselImages, $link_url);
                            endif;
                            ?>  
            ...
            <?php if (($showStars || $showLocation) && in_array($listingStyle, array(1, 5))): ?>
                ...
                <?php endif; ?>
                            ...
                            <?php endif; ?>
                            <?php if (!empty($title)): ?>
                                <<?php echo esc_attr($settings['title_size']); ?>  class="thmv-title">
                                    <?php if($this->get_settings_for_display('thmv_hide_link_title')!==""):?>
                                    <a href="<?php echo $link_url?>">
                                    <?php endif;?>
                                        <?= esc_html($title) ?>
                                    <?php if($this->get_settings_for_display('thmv_hide_link_title')!==""):?>
